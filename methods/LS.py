...
def lap_score(X, **kwargs):
    """
    Function obtained from the scikit-feature repository on GitHub by jundongl, modified to fit the current codebase.
    ...
    if 'W' not in kwargs.keys():
        ...
        W = kwargs['W']     # construct the affinity matrix W
